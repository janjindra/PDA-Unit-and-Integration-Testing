...
describe('calculator', function () {
  ...
  it('it should concatenate multiple number button clicks', function(){
    var expected = (2)
    this.previousTotal = "";
    var result = calculator.numberClick(2);
    assert.equal(this.expected, this.result)
  });

  it('it should chain multiple operations together - add', function(){
    var expected = (4)
  ...
  it('it should chain multiple operations together - subtract', function(){
    var expected = (0)
    this.previousTotal = 2
    this.previousOperator = "+"
    var result = calculator.operatorClick("-");
